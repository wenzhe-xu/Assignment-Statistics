...
其中，precision指被分类器判定正例中的正样本的比重，recall指被预测为正例的占总的正例的比重。对于多分类的问题，我们使用Marco F1-Score, 即首先求出每个类别的F1-Score，然后求平均数，作为模型的Marco F1-Score。
...
对于全模型，如下是它的混淆矩阵和一些模型的数据，我们可以看出全模型对于后场球员的预测效果最好，对于前场球员的预测效果最差。通过混淆矩阵，我们可以发现，存在很多中场球员被预测为其他位置球员和其他卑职球员被预测为中场球员的情况，这与中场位置对能力要求的全面性分不开关系。事实上，球员的位置并不是绝对不变的，很多中场球员在正式比赛中也可以客串前场球员或者后场球员，甚至有些中场球员会转型成其他位置的球员，如初出茅庐的C罗是中场球员，最擅长的是过人，但C罗转会皇马后，由于阵容要求和自身伤病趋势，逐渐转型为前锋，成为恐怖的进球机器；再有，如利物浦的后卫阿诺德，以前司职中场，后来转型成为后卫，并在后卫位置上如鱼得水，在利物浦主场上演安菲尔德奇迹逆转巴塞罗那的比赛中，他快发任意球，打的对方措手不及，成为逆转的关键。
